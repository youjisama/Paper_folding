    ...
    def calculate_auxiliary_points(self):
        ...
        for idx in corner_indices:
            ...
            if idx < len(self.points):
                self.auxiliary_points.append(self.points[idx])
                self.auxiliary_point_indices.append(idx)
...
class MainWindow(QMainWindow):
    ...
    def toggle_auxiliary_points(self):
        ...
        if self.glWidget.show_auxiliary_points:
            self.hint_label.setText("✨ 辅助点已显示 - 红色点标记四个角点位置")
        else:
